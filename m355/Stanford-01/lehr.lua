...
nsp, nmodes, gmodel = setGasModel('Stanford-2011-gas-model.lua')
...
config.reactions_file = 'Stanford-2011-reac-file.lua'
...
w = {{x=-4/3*R,y=0.0}, {x=-4/3*R,y=15*R/18}, {x=-8*R/9,y=16*R/9}, {x=0.0,y=7/3*R}}
e = {{x=-7/6*R,y=0.0}, {x=-7/6*R,y=19*R/36}, {x=-17*R/18,y=12*R/12},{x=-21*R/36,y=5*R/3}, {x=0.0, y=5/3*R}}
--Paths
...
clWest = {north=RobertsFunction:new{end0=false, end1=true, beta=1.15}, south=RobertsFunction:new{end0=false, end1=true, beta=1.15}}
clCentre = {north=RobertsFunction:new{end0=true, end1=true, beta=1.15}, south=RobertsFunction:new{end0=true, end1=true, beta=1.15}}
clEast = {north=RobertsFunction:new{end0=true, end1=true, beta=1.15}, south=RobertsFunction:new{end0=true, end1=true, beta=1.15}}
--grid = StructuredGrid:new{psurface=psurf, niv=(ni+1)/3, njv=(nj+1)/4,}
nib= 3; njb= 8
grid00 = StructuredGrid:new{psurface=p00, niv=(ni+1)/nib, njv=(nj+1)/4, cfList=clWest}
grid01 = StructuredGrid:new{psurface=p01, niv=(ni+1)/nib, njv=(nj+1)/4, cfList=clCentre}
grid02 = StructuredGrid:new{psurface=p02, niv=(ni+1)/nib, njv=(nj+1)/4, cfList=clEast}
...
----------------------------------------------------------------------------
-- History:
--   2021-06-01 : Increased clustering beta value and added clustering towards model 
--   2021-05-31 : Increased t_final by 1.5. 2021-06-01 Revoked
--   2021-04-   : PF Split grid into blocks for clustering away from model face for Chemistry refinement.
