...
t_final = 30 * body_flow_length -- allow time to establish
...
clWest = {north=RobertsFunction:new{end0=false, end1=true, beta=1.2}, south=RobertsFunction:new{end0=false, end1=true, beta=1.2}}
clCentre = {north=RobertsFunction:new{end0=true, end1=true, beta=1.2}, south=RobertsFunction:new{end0=true, end1=true, beta=1.2}}
clEast = {north=RobertsFunction:new{end0=true, end1=false, beta=1.2}, south=RobertsFunction:new{end0=true, end1=false, beta=1.2}}
...
----------------------------------------------------------------------------
-- History:
--   2021-05-31 : Increased t_final by 1.5.
